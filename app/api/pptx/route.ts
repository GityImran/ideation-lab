...
export async function POST(req: NextRequest) {
  try {
    ...
    // Generate QR codes and URLs for flashcards
    if (flashcards.length > 0) {
      ...
      flashcardSlide.addText("📚 Flashcards", {
        x: 1,
        y: 0.5,
        w: 8,
        h: 1,
    ...
    instructionsSlide.addText("📱 How to Use", {
      x: 1,
      y: 0.5,
      w: 8,
      h: 1,
    ...
    instructionsSlide.addText("💡 Tip: Backup links are provided in case QR codes don't work", {
      x: 1,
      y: 4,
      w: 8,
      h: 0.5,
